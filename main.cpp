...
Objective:	 To obtain parameters of a polynomial implementing Gradient Descent Method (Steepest Descent) [ Refer Report/Manual ]
Input:		 Measured Data, Initial Guess of Parameters, Equation Type
Output:		 Parameters of the equation, Plot showing comparision of Obtained and Fitted Values, CSV File containing  Error Propogation
...
Steps:	1. Make sure the environment is set for C++17 (Necessary for GNUPLOT Interface)
		...
		12. Change the value of 'alpha', i.e. Learning Rate according to the quality of curve fit
*/
...
/*
Main Program, consists of: Data Sourcing from Input and CSV Files, Obtaining Parameters from Gradient Descent Fit Routine
Arguments: None
